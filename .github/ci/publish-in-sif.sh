...
# (project=scitex-cv, owner=ywatanabe1989, repo=scitex-cv,
...
TMPDIR="/tmp/publish-scitex_cv-${GITHUB_RUN_ID:-0}-${GITHUB_RUN_ATTEMPT:-0}-$V"
export TMPDIR
rm -rf "$TMPDIR"
...
echo "PUBLISH-OK: scitex-cv dist/* uploaded to PyPI via manual OIDC trusted publishing"
