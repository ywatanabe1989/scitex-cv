...
def create_title_card(
    ...
    if background == "gradient":
        ...
        ax.set_facecolor(_BRAND_COLORS["primary"])
    else:
    ...
    if subtitle:
        ax.text(
            ...
            fontweight="normal",
            color=_BRAND_COLORS["text_muted"],
            transform=ax.transAxes,
        )
    ...
    fig.savefig(
        output_path,
        facecolor=_BRAND_COLORS["primary"],
        edgecolor="none",
        dpi=dpi,
    )
    plt.close(fig)
